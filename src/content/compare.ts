 ...
 *
 * Each competitor renders via src/components/marketing/ComparisonPage.tsx at /[slug]-alternative.
 */
...
export const COMPETITORS: Record<string, Competitor> = {
  upwork: {
    ...
    metaDescription:
      "Disappearing contractors, fake 'Top Rated' badges, removed reviews, 22–34% real fees. Hyrde is the Upwork alternative that vets talent with AI and is free of Hyrde fees on your first three projects.",
    ...
    painPoints: [
      ...
      },
      {
        ...
        hyrde: "Your first three projects carry no Hyrde fee — posting, matching, shortlisting and the hire itself cost nothing.",
      },
    ],
    fees: [
      ...
      { label: "Real all-in 'agency tax'", them: "≈ 22–34% of contract", hyrde: "$0 on your first 3 projects" },
    ],
    features: [
      ...
      { feature: "Predictable pricing", them: false, hyrde: "First 3 projects, no Hyrde fee" },
    ],
    faqs: [
      {
        q: "What is the best Upwork alternative for clients in 2026?",
        a: "If your problem with Upwork is talent quality and unpredictable fees, Hyrde is built for exactly that: every freelancer passes an AI work-sample assessment before you see them, there's no bidding, and it's free of Hyrde fees on your first three projects — no Connects, no contract-initiation fees, no 22–34% all-in tax.",
      },
      {
        q: "Is Hyrde cheaper than Upwork?",
        a: "For most contracts, yes. Upwork's real all-in cost lands around 22–34% once you count the marketplace fee, contract-initiation fees, and wasted Connects. Hyrde is free of Hyrde fees on your first three projects.",
      },
      {
  ...
  fiverr: {
    ...
    metaDescription:
      "Tired of gig roulette, race-to-the-bottom quality, surprise revisions and buyer fees on Fiverr? Hyrde matches you to AI-vetted talent in 60 seconds and is free of Hyrde fees on your first three projects.",
    ...
    painPoints: [
      ...
      },
      {
        ...
        hyrde: "Transparent rates up front and free of Hyrde fees on your first three projects. No nickel-and-diming.",
      },
      {
        icon: "reviews",
    ...
    fees: [
      ...
      { label: "What you pay overall", them: "Gig price + fees + extras", hyrde: "Market rate — no Hyrde fee on your first 3 projects" },
    ],
    features: [
      { feature: "Talent vetted before you see them", them: false, hyrde: "AI work-sample on every profile" },
    ...
    faqs: [
      {
        ...
        a: "Hyrde. Instead of buying a fixed gig and hoping, you describe the role and get ~5 AI-vetted professionals ranked for your brief, with transparent rates and free of Hyrde fees on your first three projects.",
      },
      {
      ...
      },
      {
        ...
        a: "No. There's no buyer service fee and no paid 'extras' to get usable deliverables. Your first three projects carry no Hyrde fee.",
      },
    ],
  },
  ...
  toptal: {
    ...
    metaDescription:
      "Love Toptal's vetting, hate the markups, opaque pricing and slow onboarding? Hyrde gives you AI-vetted talent in 60 seconds, transparent rates, and free of Hyrde fees on your first three projects — no premium gatekeeping.",
    ...
    painPoints: [
      {
        ...
        hyrde: "Transparent rates set by the freelancer, and free of Hyrde fees on your first three projects. No opaque agency markup.",
      },
      {
        ...
        hyrde: "Free to post, match, shortlist and hire on your first three projects.",
      },
      {
        icon: "schedule",
    ...
    fees: [
      ...
      { label: "Pricing transparency", them: "Opaque markup baked into rate", hyrde: "Freelancer's rate + $0 fee on your first 3 projects" },
      { label: "Time to shortlist", them: "Days, via account manager", hyrde: "~60 seconds" },
      { label: "What you pay overall", them: "Premium rate + hidden markup", hyrde: "Market rate + $0 fee on your first 3 projects" },
    ],
    features: [
    ...
    faqs: [
      {
        ...
        a: "Yes — Hyrde. Every freelancer passes an AI work-sample assessment, but there's no opaque markup or upfront deposit. You see the freelancer's real rate, and your first three projects carry no Hyrde fee.",
      },
      {
        q: "Do I need to pay a deposit like Toptal?",
        a: "No. Posting, matching, getting your shortlist and hiring carry no Hyrde fee on your first three projects. After that a plan applies; freelancers never pay.",
      },
      {

import { APP_PREFIXES, DEFAULT_LOCALE, LOCALE_COOKIE } from "./index";
...
//  2. The app's path list comes from APP_PREFIXES, the same list src/lib/i18n/theme.ts
//     and src/lib/i18n/index.ts use, rather than being pasted in by hand to drift.

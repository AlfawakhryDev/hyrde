...
import { SKILLS, CITIES, MOCK_FREELANCERS, ALL_SKILL_SLUGS, getRate } from "@/content/data";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `Find pre-vetted ${data.label}s on Hyrde. Average rate $${data.avgRate}/hr. AI-matched in 60 seconds. First 3 projects, no Hyrde fee.`,
  };
}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="font-body text-on-surface-variant text-base leading-relaxed mb-6 max-w-md">
              Get matched with pre-vetted {skillData.label}s in under 60 seconds. AI-scored candidates only. First 3 projects, no Hyrde fee.
            </p>
      ...
      <section className="max-w-[1280px] mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {[
            ...
            { q: `What makes Hyrde different?`,             a: `5 AI-curated matches instead of dozens of spam proposals. First 3 projects, no Hyrde fee. Zero cost to post. AI explains exactly why each person was matched.` },

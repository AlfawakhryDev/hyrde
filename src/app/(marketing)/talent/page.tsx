...
import { MOCK_FREELANCERS, SKILLS, CITIES } from "@/content/data";
import type { RegisteredFreelancer } from "@/content/types";
        ...
        <div className="flex items-end justify-between flex-wrap gap-4 mb-8">
          <div>
            ...
            <p className="font-body text-on-surface-variant mt-1">
              AI-scored profiles. First 3 projects, no Hyrde fee.
            </p>
          </div>
          <Link
            href="/post-job"

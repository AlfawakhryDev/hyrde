...
import { SKILLS, CITIES, getRate } from "@/content/data";
...
export default function RatesPage() {
  ...
  const findings = [
    ...
    { stat: `$0 vs 22–34%`, label: `Hyrde (first 3 projects) vs legacy-platform effective take rate` },
  ];
        ...
        <div className="bg-tech-blue-deep text-white rounded-2xl p-10 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="font-body text-on-primary-container text-sm max-w-md">
              Post a job brief and our AI finds the top 5 candidates at the right rate in 60 seconds. First 3 projects, no Hyrde fee.
            </p>
          </div>

...
import Tour, { type TourStep } from "@/components/product/Tour";
import {
  parseTaskLimitError, activeSub, pendingSub, FREE_PROJECTS,
  type Subscription,
} from "@/lib/billing";
import ProjectComposer, { PROJECT_TEMPLATES } from "@/components/product/dashboard/ProjectComposer";
import { ProgressBar } from "@/components/product/task/MilestoneProgress";
import { useT } from "@/components/shared/I18nProvider";
import WhereAreYou from "@/components/product/WhereAreYou";
import StartHereClient from "@/components/product/dashboard/StartHereClient";
import MessageDock from "@/components/product/task/MessageDock";

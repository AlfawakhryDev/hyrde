...
import { ALL_SKILL_SLUGS, INDEXED_CITY_PAGES } from "@/content/data";
import { COMPETITOR_SLUGS } from "@/content/compare";
import { GUIDE_SLUGS, GUIDES } from "@/content/guides";
import { AR_GUIDE_SLUGS, AR_GUIDES } from "@/content/guides.ar";
import { DE_GUIDE_SLUGS, DE_GUIDES } from "@/content/guides.de";
import { AR_CITY_SLUGS } from "@/content/gcc.ar";

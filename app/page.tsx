...
export const metadata: Metadata = {
  ...
  description:
    "Hyrde is an AI-native freelance platform. Describe an outcome or task and the AI matches it to one interview-vetted specialist — no bidding, no proposal spam, no pay-to-apply. Freelancers keep 100%, and your first three projects carry no Hyrde fee.",
  alternates: { canonical: "/", languages: altLanguages("/", "/de", "/ar") },
  openGraph: {
    title: "Hire Interview-Vetted Freelancers, AI-Matched | Hyrde",
    description:
      "AI-vetted talent, matched to your task. No bidding, no proposal spam. First 3 projects, no Hyrde fee.",
    url: "https://hyrde.net",

...
export const metadata: Metadata = {
  ...
  description: "Browse 25+ skill categories. AI-matched talent in 60 seconds. First 3 projects, no Hyrde fee.",
};
    ...
    <div className="min-h-screen bg-surface-gray">
      <section className="max-w-[1280px] mx-auto px-6 md:px-12 pt-20 pb-16">
        ...
        <div className="mb-12">
          ...
          <p className="font-body text-on-surface-variant text-lg">AI-matched. Verified. First 3 projects, no Hyrde fee.</p>
        </div>

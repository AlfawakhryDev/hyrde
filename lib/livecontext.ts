...
export function liveContextUpdate(category: string, locale = "en"): string {
  const base = `This candidate is being vetted for the "${category}" category. Tailor every question specifically to ${category}.`;
  if (locale === "ar") {
